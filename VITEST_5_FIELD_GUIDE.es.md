...
**Arreglo.** Resuelve el elemento exacto a su `backendNodeId` CDP, pide a CDP la
geometría de ese nodo con `DOM.getContentQuads()`, calcula el centro y dispara
los eventos de mouse en ese punto:
